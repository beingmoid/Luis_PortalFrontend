...
import { LookupService } from './services/APIServices/lookup.service'
...
export class AppComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.lookupService.getTimeZone();
    this.router.events
      .pipe(
      ...
      .subscribe(event => this.titleService.setTitle(`Stacket ${event['title'] ? "| " + event['title'] : ''}`))
